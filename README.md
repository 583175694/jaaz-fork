...
- Image tool: `generate_image_by_gpt_image_2_edit_apipod`
- Video tool: `generate_video_by_veo3_apipod`

This production build uses a fixed built-in runtime. End users cannot switch providers or models.
