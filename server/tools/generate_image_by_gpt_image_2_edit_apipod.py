...
@tool(
    ...
    description="Generate or edit an image using APIPod GPT Image 2 / GPT Image 2 Edit. Use this when reference images are provided or when image editing is needed.",
...
async def generate_image_by_gpt_image_2_edit_apipod(
    ...
    return await generate_image_with_provider(
        ...
        model="gpt-image-2-edit" if input_images else "gpt-image-2",
        prompt=prompt,
