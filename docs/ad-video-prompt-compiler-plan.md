# AI Studio 通用广告营销视频 Prompt Compiler 方案

## 1. 文档目的

本文档用于沉淀 AI Studio 在“分镜图生成 + 选中分镜图生成视频”场景下的完整优化方案。
...
因此，这个方案本质上是在把 AI Studio 从“模型调用器”升级成“广告内容 Prompt Compiler”。
...
让 AI Studio 具备一套通用广告营销内容的专业编译能力。
