# AI Studio 主图驱动分镜与多机位多视角综合方案

## 1. 文档目的

本文档用于统一沉淀 AI Studio 在以下方向上的综合方案：
...
也就是说，AI Studio 需要从“图像生成器”进一步升级为“分镜与镜头组织系统”。
...
因为这条链路和 AI Studio 当前“选中分镜图生成视频”的路径更一致，也更容易形成系统闭环。
